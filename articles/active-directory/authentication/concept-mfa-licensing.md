...
| Office 365 Business Premium, E3, or E5 | Azure Multi-Factor Authentication can be enabled, enforced, or disabled for all users, a single user, updated across multiple users in bulk, or via PowerShell. Once enabled or enforced, MFA will apply to selected across all Office 365 sign-in events. Management of MFA by enabeling, enforcing or disabling is accomplished via the Office 365 Admin Center and user administration. For an improved user experience, upgrade to Azure AD Premium P1 or P2 and use Conditional Access. For more information, see [secure Office 365 resources with multi-factor authentication](https://support.office.com/article/Set-up-multi-factor-authentication-for-Office-365-users-8f0454b2-f51a-4d9c-bcde-2c48e41621c6). |
